...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user2 = new User("Sahil", pwEncoder.encode("8520"), "sahil@gamail.com", "Sahil", "Mane", "Wai", "9658423152", "Wai");
			user2.setRole("ROLE_EMPLOYEE");
			
			User user3 = new User("Atharv", pwEncoder.encode("1234"), "atharv12@gmail.com", "Atharv", "Nikam", "Kumbharwadi", "7517652298", "Wai");
